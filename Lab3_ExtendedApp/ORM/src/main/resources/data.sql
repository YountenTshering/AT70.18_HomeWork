...
insert into employee_info (employee_age, fname, lname, mname, user_id) values (20, 'Younten', 'Tshering', ' ', 1);
insert into employee_info (employee_age, fname, lname, mname, user_id) values (69, 'Yoyo', 'Sing', ' ', 2);
