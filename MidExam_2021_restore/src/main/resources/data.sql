...
insert into Employee (user_id, name, level, birthday, base_salary) values (1, 'Younten', 'C1', '2020-01-02', 101001);
insert into Employee (user_id, name, level, birthday, base_salary) values (2, 'YT', 'C2', '2020-01-02', 101001);
insert into Employee (user_id, name, level, birthday, base_salary) values (3, 'SYT', 'C3', '2020-01-02', 101001);
insert into Employee (user_id, name, level, birthday, base_salary) values (4, 'JJ', 'C1', '2020-01-02', 101001);


insert into address (city, house_no, street, zipcode, emp_user_id) values ('Bangkok', '30/6', 'Ramindra', '10220', 1);
insert into address (city, house_no, street, zipcode, emp_user_id) values ('Bangkok', '30/7', 'Victory Monument', '12220', 2);
