insert into user (username, password, active, role) values ('Younten', '$2y$12$2LA4/IzwsfoF.SFtdxwJIus48N6JwFzTdMwlrc9lXRHnA9EOBU7AS', true, 'ROLE_ADMIN');
...
insert into employee_info (employee_age, fname, lname, mname, user_id) values (20, 'Younten', 'Silpasuwanchai', ' ', 1);
insert into employee_info (employee_age, fname, lname, mname, user_id) values (69, 'Yoyo', 'Cahill', ' ', 2);
